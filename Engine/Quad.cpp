...
//初期化
HRESULT Quad::Initialize(LPCWSTR fileName)
{
	//頂点情報
...
//テクスチャをロード
HRESULT Quad::LoadTexture(LPCWSTR fileName)
{
...
//コンスタントバッファに各種情報を渡す
void Quad::PassDataToCB(DirectX::XMMATRIX worldMatrix, XMMATRIX transform)
{
	CONSTANT_BUFFER cb;
	cb.matWVP = XMMatrixTranspose(worldMatrix * Camera::GetViewMatrix() * Camera::GetProjectionMatrix());
	cb.matNormal = XMMatrixTranspose(transform);//影の付き方　法線
